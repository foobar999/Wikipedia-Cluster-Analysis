...
# TODO contributions -> contribs in anderen scripts
...
MIN_AUTH_DOCS=1
MIN_DOC_AUTHS=1
( time python scripts/history_to_contribs.py --history-dump=$COLL_PREFIX-pages-meta-history.xml.bz2 --id2author=$CONTRIB_PREFIX-id2author.cpickle.bz2 --contribs=$CONTRIB_PREFIX-raw-contribs.mm --contribution-value=$CONTRIBUTION_VALUE --min-auth-docs=$MIN_AUTH_DOCS --min-doc-auths=$MIN_DOC_AUTHS --namespace-prefixes=$NAMESPACE_PREFIXES_FILE ) |& tee $LOG_PREFIX-contribs.log
...
mv $CONTRIB_PREFIX-raw-contribs.mm.metadata.cpickle $CONTRIB_PREFIX.titles.cpickle # Artikeltitel-Datei umbennen
bzip2 -zf $CONTRIB_PREFIX-raw-contribs.mm $CONTRIB_PREFIX.titles.cpickle # komprimiere Beiträge, Artikeltitel
bzip2 -dkf $CONTRIB_PREFIX-raw-contribs.mm.bz2  # TODO produktiv raus
...
bzip2 -zf $CONTRIB_PREFIX-acc-contribs.mm $CONTRIB_PREFIX-doc-auth-contribs.mm $CONTRIB_PREFIX-auth-doc-contribs.mm
bzip2 -dkf $CONTRIB_PREFIX-acc-contribs.mm.bz2 $CONTRIB_PREFIX-doc-auth-contribs.mm.bz2 $CONTRIB_PREFIX-auth-doc-contribs.mm.bz2 # TODO produktiv raus
